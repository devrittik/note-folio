...
export const siteSettingsSchema = defineType({
  ...
  fields: [
    ...
    defineField({ name: 'favoriteQuote', title: 'Favorite quote', type: 'text', rows: 3, group: 'home', description: 'Optional quote shown at the end of the homepage.' }),
    defineField({ name: 'favoriteQuoteAuthor', title: 'Quote attribution', type: 'string', group: 'home' }),
